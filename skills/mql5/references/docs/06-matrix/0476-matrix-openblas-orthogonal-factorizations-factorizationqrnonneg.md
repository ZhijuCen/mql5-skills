...
Computes the QR factorization of a general m-by-n matrix: A = Q * R. R is an upper triangular matrix with nonnegative diagonal entries. LAPACK function [GEQRFP](https://www.intel.com/content/www/us/en/docs/onemkl/developer-reference-fortran/2025-2/geqrfp.html).
