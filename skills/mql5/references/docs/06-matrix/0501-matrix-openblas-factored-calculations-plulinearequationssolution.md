...
with an LU-factored square coefficient matrix AF computed by [FactorizationPLURaw](/en/docs/matrix/openblas/factorizations/factorizationpluraw), with multiple right-hand sides. LAPACK function [GETRS](https://www.intel.com/content/www/us/en/docs/onemkl/developer-reference-fortran/2025-2/getrs.html).
