...
Here A and B are assumed to be symmetric (Hermitian) and B is also positive definite. This method uses QR algorithm (LAPACK functions [SYGV](https://www.intel.com/content/www/us/en/docs/onemkl/developer-reference-fortran/2025-2/sygv.html), [HEGV](https://www.intel.com/content/www/us/en/docs/onemkl/developer-reference-fortran/2025-2/hegv.html)).
