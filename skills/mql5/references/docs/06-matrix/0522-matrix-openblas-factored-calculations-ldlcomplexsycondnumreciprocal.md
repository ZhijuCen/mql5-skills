...
Estimates the reciprocal of the condition number of a complex symmetric indefinite matrix A, using the LDLT factorization computed by [FactorizationLDLComplexSyRaw](/en/docs/matrix/openblas/factorizations/factorizationldlcomplexsyraw). LAPACK function [SYCON](https://www.intel.com/content/www/us/en/docs/onemkl/developer-reference-fortran/2025-2/sycon.html).
