...
LAPACK function [TRSYL3](https://www.intel.com/content/www/us/en/docs/onemkl/developer-reference-fortran/2025-2/trsyl3.html). This is the block (BLAS level 3) version of [TRSYL](/en/docs/matrix/openblas/sylvester_equations/sylvesterequationtriangular). Faster up to 5 times but not so accurate.
