...
Solves a system of linear equations  A * X = B  with a real symmetric or complex Hermitian indefinite matrix using the factorization A = U**T * D * U or A = L * D * L**T computed by [FactorizationLDLRaw](/en/docs/matrix/openblas/factorizations/factorizationldlraw), with multiple right-hand sides. LAPACK functions [SYTRS](https://www.intel.com/content/www/us/en/docs/onemkl/developer-reference-fortran/2025-2/sytrs.html), [HETRS](https://www.intel.com/content/www/us/en/docs/onemkl/developer-reference-fortran/2025-2/hetrs.html).
