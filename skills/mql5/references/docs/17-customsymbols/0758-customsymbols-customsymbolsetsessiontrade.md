...
//--- in a loop by day of the week from Mon to Fri, print the start and end times of each trading session in the journal 
...
[SymbolInfoSessionTrade](/en/docs/marketinformation/symbolinfosessiontrade), [Symbol info](/en/docs/constants/environment_state/marketinfoconstants), [TimeToStruct](/en/docs/dateandtime/timetostruct), [Date structure](/en/docs/constants/structures/mqldatetime)
