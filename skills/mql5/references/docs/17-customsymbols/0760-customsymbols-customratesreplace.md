...
[in]  Number of the rates[] array elements to be used for replacement. [WHOLE_ARRAY](/en/docs/constants/namedconstants/otherconstants) means that all rates[] array elements should be used for replacement.
