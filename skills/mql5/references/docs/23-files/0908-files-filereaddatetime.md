...
[Type datetime](/en/docs/basis/types/integer/datetime), [StringToTime](/en/docs/convert/stringtotime), [TimeToString](/en/docs/convert/timetostring), [FileWrite](/en/docs/files/filewrite)
