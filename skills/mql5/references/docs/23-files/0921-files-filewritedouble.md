...
If successful the function returns the number of bytes written (in this case [sizeof](/en/docs/basis/operations/other#sizeof)(double)=8). The file pointer is shifted by the same number of bytes.
