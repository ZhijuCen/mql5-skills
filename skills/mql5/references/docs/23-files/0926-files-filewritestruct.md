...
[in] Reference to the object of this structure. The structure should not contain strings, [dynamic arrays](/en/docs/basis/types/dynamic_array) or [virtual functions](/en/docs/basis/oop/virtual).
