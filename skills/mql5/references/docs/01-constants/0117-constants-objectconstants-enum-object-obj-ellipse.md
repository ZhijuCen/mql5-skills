...
![Note](pics/objellipse.png)

Note

For ellipse, the mode of filling with color can be set using [OBJPROP_FILL](/en/docs/constants/objectconstants/enum_object_property#enum_object_property_integer) property.
