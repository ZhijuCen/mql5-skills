...
![Note](pics/objtext.png)

Note

Anchor point position relative to the text can be selected from [ENUM_ANCHOR_POINT](/en/docs/constants/objectconstants/enum_anchorpoint) enumeration. You can also change text slope angle using [OBJPROP_ANGLE](/en/docs/constants/objectconstants/enum_object_property#enum_object_property_double) property.
