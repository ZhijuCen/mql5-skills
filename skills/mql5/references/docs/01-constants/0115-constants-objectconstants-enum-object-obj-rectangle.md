...
![Note](pics/objrectangle.png)

Note

For rectangle, the mode of filling with color can be set using [OBJPROP_FILL](/en/docs/constants/objectconstants/enum_object_property#enum_object_property_integer) property.
