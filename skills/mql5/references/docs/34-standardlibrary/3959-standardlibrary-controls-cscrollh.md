...
Result of the [code](/en/docs/standardlibrary/controls/cscrollh#sample) provided below:

![Example of creating a panel with horizontal scrollbar:](pics/controlsscrollh.png)
