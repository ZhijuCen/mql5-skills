...
![where:](pics/pdf_t_distribution.png)
...
![In addition to the calculation of the individual random variables, the library also implements the ability to work with arrays of random variables.](pics/demotdistribution.png)
