...
It gets the position reverse volume ([LotReverse()](/en/docs/standardlibrary/expertclasses/expertbaseclasses/cexpert/cexpertlotreverse) method) and reverses a long position (Sell() method of Trade object) if trading volume is not equal to 0.
