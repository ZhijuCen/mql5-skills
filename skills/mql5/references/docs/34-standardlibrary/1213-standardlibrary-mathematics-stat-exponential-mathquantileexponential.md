...
For the specified probability, the function calculates the value of inverse exponential distribution function with the mu parameter. In case of error it returns [NaN](/en/docs/basis/types/double).
...
For the specified probability[] array of probability values, the function calculates the value of inverse exponential distribution function with the mu parameter. In case of error it returns false. Analog of the [qexp()](https://stat.ethz.ch/R-manual/R-devel/library/stats/html/Exponential.html) in R.
