...
Value of "Pips per bar" property of the object assigned to the class instance. If there is no object assigned, it returns [EMPTY_VALUE](/en/docs/constants/namedconstants/otherconstants).
