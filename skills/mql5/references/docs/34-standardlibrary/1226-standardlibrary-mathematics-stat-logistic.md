...
![where:](pics/pdf_logistic_distribution.png)
...
![In addition to the calculation of the individual random variables, the library also implements the ability to work with arrays of random variables.](pics/demologisticdistribution.png)
...
| MathMomentsLogistic | Calculates the theoretical numerical values of the first 4 moments of the logistic distribution |
