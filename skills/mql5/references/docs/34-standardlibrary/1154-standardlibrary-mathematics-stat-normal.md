...
![where:](pics/pdf_normal_distribution.png)
...
![In addition to the calculation of the individual random variables, the library also implements the ability to work with arrays of random variables.](pics/demonormaldistribution.png)
