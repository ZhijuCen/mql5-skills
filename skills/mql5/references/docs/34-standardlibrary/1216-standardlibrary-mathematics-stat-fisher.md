...
![where:](pics/pdf_f_distribution.png)
...
![In addition to the calculation of the individual random variables, the library also implements the ability to work with arrays of random variables.](pics/demofdistribution.png)
