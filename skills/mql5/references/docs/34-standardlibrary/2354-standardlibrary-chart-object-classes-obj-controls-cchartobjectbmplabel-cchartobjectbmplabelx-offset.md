...
Gets the value of "X_Offset" property (the upper left corner) of the [CCartObjectBmpLabel](/en/docs/standardlibrary/chart_object_classes/obj_controls/cchartobjectbmplabel) graphical object.
