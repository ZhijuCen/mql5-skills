...
Calculates the value of the probability density function of chi-squared distribution with the nu parameter for a random variable x. In case of error it returns [NaN](/en/docs/basis/types/double).
...
Calculates the value of the probability density function of chi-squared distribution with the nu parameter for an array of random variables x[]. In case of error it returns false. Analog of the [dchisq()](https://stat.ethz.ch/R-manual/R-devel/library/stats/html/Chisquare.html) in R.
