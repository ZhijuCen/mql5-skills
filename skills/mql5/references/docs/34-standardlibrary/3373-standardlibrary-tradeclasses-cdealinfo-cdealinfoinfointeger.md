...
[in]  ID of integer type property from [ENUM_DEAL_PROPERTY_INTEGER](/en/docs/constants/tradingconstants/dealproperties#enum_deal_property_integer) enumeration.
