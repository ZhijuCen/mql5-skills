...
Calculates the value of the probability density function of noncentral Fisher's F-distribution with the nu1, nu2 and sigma parameters for a random variable x. In case of error it returns [NaN](/en/docs/basis/types/double).
...
Calculates the value of the probability density function of noncentral Fisher's F-distribution with the nu1, nu2 and sigma parameters for an array of random variables x[]. In case of error it returns false. Analog of the [df()](https://stat.ethz.ch/R-manual/R-devel/library/stats/html/Fdist.html) in R.
