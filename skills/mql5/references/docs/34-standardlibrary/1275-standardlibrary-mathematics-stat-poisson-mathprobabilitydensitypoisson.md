...
Calculates the value of the probability mass function of Poisson distribution with the lambda parameter for a random variable x. In case of error it returns [NaN](/en/docs/basis/types/double).
...
Calculates the value of the probability mass function of Poisson distribution with the lambda parameter for an array of random variables x[]. In case of error it returns false. Analog of the [dhyper()](https://stat.ethz.ch/R-manual/R-devel/library/stats/html/Hypergeometric.html) in R.
