...
Result of the [code](/en/docs/standardlibrary/controls/ccheckbox#sample) provided below:

![Example of creating a panel with Checkbox control:](pics/controlscheckbox.png)
