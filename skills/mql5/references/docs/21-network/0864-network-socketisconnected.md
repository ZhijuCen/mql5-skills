...
[SocketConnect](/en/docs/network/socketconnect), [SocketIsWritable](/en/docs/network/socketiswritable), [SocketCreate](/en/docs/network/socketcreate), [SocketClose](/en/docs/network/socketclose)
