...
![Add an explicit message to the MQL5 program to notify a user of the need for additional configuration. You can do that via  #property description ,  Alert  or  Print .](pics/allow_net_request.png)
