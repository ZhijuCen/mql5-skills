...
[in]  Number of bytes to read to the buffer[] array. Data not fitting into the array remain in the socket. They can be received by the next SocketRead call. buffer_maxlen cannot exceed [INT_MAX](/en/docs/constants/namedconstants/typeconstants) (2147483647).
